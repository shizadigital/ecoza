						...
						<div class="table-responsive">
							<table class="table table-striped table-hover">
								...
								<tbody>
									...
									foreach ($data AS $r){
                                        $unitname = t( array( 'table'=>'unit_length', 'field'=>'lengthUnit', 'id'=>$r['lengthId']) );
                                        $unitexplanation = t( array( 'table'=>'unit_length', 'field'=>'lengthTitle', 'id'=>$r['lengthId']) );
									?>
									<tr>
										...
										<td>
											<?php echo $unitname . ( ($r['lengthDefault']=='y') ? ' <strong>('.t('default').')</strong>':'' ); ?><br/>
											<div class="btn-group btn-group-xs">
												<?php if(is_edit()){ ?>
												<a href="<?php echo admin_url($this->uri->segment(2).'/edit/'.$r['lengthId']); ?>" class="btn btn-sm btn-info"><i class="fe fe-edit"></i> <?php echo t('edit'); ?></a> 
												<?php } 
												if(is_delete()){ ?>
												...
												<!-- Modal -->
												<div class="modal fade" id="myModal<?php echo $r['lengthId']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
													<div class="modal-dialog" style="width:400px;">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<a class="btn btn-danger btn-sm" href="<?php echo admin_url($this->uri->segment(2).'/delete/'.$r['lengthId']); ?>"><i class="icon_trash_alt"></i> <?php echo t('delete'); ?></a>
															</div>
														</div><!-- /.modal-content -->
													</div>
													<!-- /.modal-dialog -->
										...
										<td class="text-right">
											<?php echo digitFormat($r['lengthValue'],8); ?>
										</td>
									</tr>
									<?php $no++; } ?>
								</tbody>
