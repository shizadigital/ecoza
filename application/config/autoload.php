...
if($ci->uri->segment(1) == $ci->config->item('admin_slug') ){
	...
	if( $segment_lowertrim != 'migration' ){
		$autoloaderlibset = array('navigation','permalink','meta','shopping_cart','member');
	}
...
*/
$autoload['helper'] = array('url','cookie','file','form','language','filtering','app_options','functions','shop_engine');
...
*/
$autoload['model'] = array('Adminenv_model','Env_model');
