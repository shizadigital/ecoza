                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php if($r['levelId']=='1'){ ?>
                                        <input type="hidden" name="mod_active[1]" value="y" /><i class="icon-checkmark4"></i>
                                        <?php } else { ?>
                                    ...
                                    <td class="text-center">
                                        <?php 
                                        if( is_edit() ){
                                            echo "<a href=\"".admin_url($this->uri->segment(2)."/edit/".$r['levelId'])."\" class=\"btn btn-info btn-sm\"><i class=\"icon-pencil\"></i> Edit</a>";
                                        }
                                        ?>
                                    </td>
                                </tr>
