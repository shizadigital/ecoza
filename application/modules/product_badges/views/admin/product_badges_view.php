									...
									<tr>
										<td class="text-center">
											<div class="form-group">
												...
												<input type="hidden" name="item_val[]" value="<?php echo $r['badgeId']; ?>" />
											</div>
										</td>
										...
										<td>
											...
											<div class="btn-group btn-group-xs">
												...
												<!-- Modal -->
												<div class="modal fade" id="myModal<?php echo $r['badgeId']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
													<div class="modal-dialog" style="width:400px;">
														<div class="modal-content">
															...
															<div class="modal-body text-center">
																...
																<strong><?php echo t('productbadges').': '.$label; ?></strong>
															</div>
															<div class="modal-footer">
																<button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><?php echo t('cancel'); ?></button>
																<a class="btn btn-danger btn-sm" href="<?php echo admin_url($this->uri->segment(2).'/delete/'.$r['badgeId']); ?>"><i class="icon_trash_alt"></i> <?php echo t('delete'); ?></a>
															</div>
														</div><!-- /.modal-content -->
													</div>
													<!-- /.modal-dialog -->
