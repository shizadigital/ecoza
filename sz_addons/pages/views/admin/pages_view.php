						...
						<div class="row">
							...
							<div class="col-md-8">
								<div class="mt-xxs-0 btn-group btn-group-toggle">
									<?php 
                                    $countdtproddraft = countdata("contents","contentStatus='0' AND contentType='page'");
					...
					<div class="col-md-12 py-3 table-responsive-md">
						<table class="table table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<div class="btn-group btn-group-sm">
											<a href="<?php echo base_url('/page/'.$r['contentId'].'-'.$r['contentSlug']); ?>" class="btn btn-sm btn-secondary" target="_blank"><i class="fe fe-link-2"></i> <?php echo t('view'); ?></a>
											<?php if(is_edit()){ ?>
								...
								?>
								<tr>
									<td colspan="5" class="text-center"><?php echo t('nodatafound');?></td>
								</tr>
								<?php 
								}
								?>
