		...
		<div class="card card-statistics">
			<div class="card-header">
				<div class="card-heading">
					<h5 class="card-title mb-0"><?php echo t('edit') . ' '.$data['countryName']; ?></h5>
				</div>
			</div>
			...
			<?php 
				...
				$tagForm = array(
					...
					'hidden' 		=> array('ID' => $data['countryId'])
				);
				...
				$inputs = array(
					...
					'inputs' => array(
						...
						array(
							...
							'value' => '1',
							'title' => t('yes'),
							'checked' => ($data['countryStatus']==1) ?true:false
						),
						array(
							'type' => 'submit',
