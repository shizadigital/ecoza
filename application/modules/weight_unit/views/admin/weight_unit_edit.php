		...
		<div class="card card-statistics">
			<div class="card-header">
				<div class="card-heading">
					<h5 class="card-title mb-0"><?php echo t('editweight'); ?></h5>
				</div>
			</div>
				...
				$inputs = array(
					...
					'inputs' => array(
						...
						array(
							...
							'help' => t('commainfo'),
                            'required' => true,
                            'value' => str_replace('.',',',$data['weightValue']),
                        ),
						array(
							'type' => 'checkbox',
							'label' => t('default'),
							...
							'value' => 'y',
							'title' => t('yes'),
							'checked' => ($data['weightDefault']=='y') ?true:false
						),
						array(
							'type' => 'submit',
